...
enum class PosTypes(val text: String) {
    NO_POS("品詞なし"),
    NOUN("名詞"),
    ABBREVIATION("短縮よみ"),
    SUGGESTION_ONLY("サジェストのみ"),
    PROPER_NOUN("固有名詞"),
    PERSONAL_NAME("人名"),
    FAMILY_NAME("姓"),
    FIRST_NAME("名"),
    ...
    ADJECTIVE_VERBAL_NOUN("名詞形動"),
    NUMBER("数"),
    ALPHABET("アルファベット"),
    SYMBOL("記号"),
    EMOTICON("顔文字"),
    ADVERB("副詞"),
    PRENOUN_ADJECTIVAL("連体詞"),
    CONJUNCTION("接続詞"),
    INTERJECTION("感動詞"),
    PREFIX("接頭語"),
    COUNTER_SUFFIX("助数詞"),
    GENERIC_SUFFIX("接尾一般"),
    PERSON_NAME_SUFFIX("接尾人名"),
    PLACE_NAME_SUFFIX("接尾地名"),
    WA_GROUP1_VERB("動詞ワ行五段"),
    KA_GROUP1_VERB("動詞カ行五段"),
    SA_GROUP1_VERB("動詞サ行五段"),
    TA_GROUP1_VERB("動詞タ行五段"),
    NA_GROUP1_VERB("動詞ナ行五段"),
    MA_GROUP1_VERB("動詞マ行五段"),
    RA_GROUP1_VERB("動詞ラ行五段"),
    GA_GROUP1_VERB("動詞ガ行五段"),
    BA_GROUP1_VERB("動詞バ行五段"),
    HA_GROUP1_VERB("動詞ハ行四段"),
    GROUP2_VERB("動詞一段"),
    KURU_GROUP3_VERB("動詞カ変"),
    SURU_GROUP3_VERB("動詞サ変"),
    ZURU_GROUP3_VERB("動詞ザ変"),
    RU_GROUP3_VERB("動詞ラ変"),
    ADJECTIVE("形容詞"),
